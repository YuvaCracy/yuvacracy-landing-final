...
const PartnerCard = ({ data }) => {
  return (
    <div className=' p-[1rem] border-[1px]  rounded-xl hover:scale-[1.01] duration-300 cursor-pointer flex flex-col gap-[.5rem] font-openSans w-[21rem] h-[20rem] justify-center ' >
