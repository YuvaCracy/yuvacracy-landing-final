...
const PromotionalContent = () => {
  ...
  return (
    <Suspense
      fallback={
        <div className={` ${showPromo ? " mt-0 relative " : " mt-[-4rem] "} duration-700 relative sm:flex hidden items-center justify-center w-full h-16 px-32 bg-primary`} />
      }>
      <div className={` ${showPromo ? " mt-0 relative " : " mt-[-4rem] "} duration-700 relative sm:flex hidden items-center justify-center w-full h-16 md_desktop:px-32 px-20 bg-primary`}>
        {/* Slider code */}
