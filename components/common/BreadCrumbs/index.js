        ...
        {segments.map((segment, index) => {
          ...
          return (
            <div key={index} className="flex items-center">
              ...
              {isLast ? (
                <span className="text-gray-400 capitalize cursor-pointer ">{segment == "about-yuvacracy" ? "About-YuvaCracy" : segment == "yuvacracy-a-safe-space" ? "YuvaCracy-A-Safe-Space" : segment}</span>
              ) : (
