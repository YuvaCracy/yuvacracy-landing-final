import { StoriesImpactImage } from "@/public/assetManager";
...
const CareerData = [
  ...
  {
    headline: "Inspiring Success",
    desc: "Emily's success story highlights the importance of motivation and perseverance. Starting with just $1,000, Emily's determination and innovative approach helped her grow her business to $15,000 within five years. She now mentors other aspiring entrepreneurs, sharing her knowledge and experiences to help them achieve their own success stories.",
    userName: "emily-johnson",
    slug: "emily-inspiring-success",
    images: [
      {
        src: StoriesImpactImage,
      }
  ...
  {
    headline: "Building Trust Through Leadership",
    desc: "Sophia's leadership transformation has significantly impacted her team's trust and collaboration. By applying the principles learned in her leadership training, Sophia cultivated a culture of openness and mutual support within her team. As a result, productivity has soared, and the team's improved morale has led to better overall business outcomes.",
    userName: "sophia-wilson",
    slug: "sophia-building-trust-leadership",
    images: [
      {
        src: StoriesImpactImage,
      }
  ...
  {
    headline: "Empowering the Youth",
    desc: "David's initiative to create an after-school program for at-risk youth has been life-changing for many. Through mentorship and education, David has provided a safe space for young people to learn and grow. His program has not only improved academic outcomes but also fostered a sense of belonging and purpose among the participants.",
    userName: "david-martinez",
    slug: "david-empowering-youth",
    images: [
      {
        src: StoriesImpactImage,
      }
